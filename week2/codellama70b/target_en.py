...
# after many attemps I could not get codellama70b to refactor the code
# most of the times it returnde the same code as the original one or returns nothing